...
/*	$FreeBSD: stable/7/sys/dev/usb/if_zyd.c 184009 2008-10-18 04:11:25Z weongyo $	*/
...
static void	zyd_start_locked(struct ifnet *);
...
static void
zyd_start_locked(struct ifnet *ifp)
{
	struct zyd_softc *sc = ifp->if_softc;
	struct ieee80211com *ic = &sc->sc_ic;
